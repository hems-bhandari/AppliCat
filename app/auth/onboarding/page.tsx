    ...
    return (
        <div className="relative w-full h-screen">
            <div className="absolute left-0 top-0 w-full md:w-1/2 h-full">
                ...
                <div className="absolute inset-0 flex items-center m-10" style={{ marginRight: "50px", height: '120px', marginTop:"480px" }}>
                    <div className="typewriter-container" style={{ height: '100%', overflow: 'hidden' }}>
                        <Typewriter
                            options={{
                                strings: ["Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard"],
                                autoStart: true,
                                loop: true,
                            }}
                        />
            ...
            <div className="absolute right-0 top-0 w-full md:w-1/2 h-full flex items-center justify-center">
                <div className="max-w-lg mx-auto md:w-2/3 px-4 py-6 bg-white rounded-lg shadow-lg" style={{ backgroundColor: '#101418' }}>
                    <form onSubmit={handleSubmit} className='*:mt-4 *:space-y-2/3'>
                        <div className="input">
                            <label htmlFor="userName" className="text-sm md:text-xs">Full Name</label>
                            <input
                                type="text"
                                id="userName"
                                name="userName"
                        ...
                        <div className="input">
                            <label htmlFor="phonenumber" className="text-sm md:text-xs"> Phone Number</label>
                            <input
                                type="tel"
                                id="phonenumber"
                                name="phonenumber"
                        ...
                        <div className="input">
                            <label htmlFor="highschool" className="text-sm md:text-xs">High School Name</label>
                            <input
                                type="text"
                                id="highschool"
                                name="highschool"
                        ...
                        <div className="input">
                            <label htmlFor="education" className="text-sm md:text-xs">Education</label>
                            <select id="education"
                                name="education"
                        ...
                        <div className="input">
                            <label htmlFor="gpa" className="text-sm md:text-xs">GPA/Grades</label>
                            <input
                                type="gpa"
                                maxLength={4}
                                id="gpa"
                        ...
                        <div className="input">
                            <label htmlFor="sat" className="text-sm md:text-xs"> SAT Score</label>
                            <input
                                type="sat"
                                maxLength={4}
                                id="sat"
