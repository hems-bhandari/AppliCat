      ...
      <div className="flex flex-col md:!flex-row items-start justify-between gap-8">
        <div className="companyInfo flex flex-row items-start justify-start gap-4 ">
          ...
          <div className="max-w-[300px] flex flex-col justify-between">
            <h2
              style={katibeh.style}
              className={`${katibeh.className} text-5xl text-white leading-none`}
            >
              Applicat
            </h2>
            <p className="text-md">
        ...
        <div className="flex flex-row  max-md:gap-8 max-md:w-full max-md:justify-between gap-24 max-md:flex-wrap">
          ...
          <div className="services flex flex-col gap-2 ">
            <h4
              style={katibeh.style}
              className={`${katibeh.className} text-3xl text-white -mt-2 `}
            >
              Links
            </h4>
            <Link href="applicat.tech/auth">Login/SignUp</Link>
            <Link href="applicat.tech/applicant">Dashboard</Link>
            <Link href="applicat.tech/applicant/sessions">Book a Session</Link>
            <Link href="applicat.tech">About</Link>
          </div>
        </div>
      </div>
      <hr className="border-[#B2B2B2] my-6" />
      <div className="flex flex-row mx-auto text-white items-center justify-center gap-2">
        <Link href="/terms_of_service" className="underline">
          Terms of Service
        </Link>
